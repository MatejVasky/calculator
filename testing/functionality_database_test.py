...
class FunctionalityDatabaseTest(unittest.TestCase):
    def test_init(self):
        fd = FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
        ...
        self.assertEqual(fd.implicit_operator, ' ')
        ...
        self.assertDictEqual(fd.left_brackets, {'(': None})
        self.assertDictEqual(fd.operations, {' ': IMPLICIT_OPERATION, '()': FUNCTION_APPLICATION_OPERATION})
    ...
    def test_init_wrong_type1(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(1, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_type2(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(IMPLICIT_OPERATION, 1, '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_type3(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, 1, ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    ...
    def test_init_wrong_type6(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', 1, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_type7(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, 1, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_type8(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, 1, PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_type9(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, 1, parse_int, parse_decimal)
    def test_init_wrong_type10(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', set([' ', '\t', 3]), LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_type11(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, set(['a', 'b', 3]), DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_type12(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, set(['0', 1, '2']), PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_type13(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, set([',', '+', 2]), parse_int, parse_decimal)
    def test_init_wrong_len1(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', set([' ', '\t\t', '\n']), LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_len2(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, set(['a', 'b', 'cd']), DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_len3(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, set(['0', '12', '2']), PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_len4(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, set([',', '+', '+-']), parse_int, parse_decimal)
    def test_init_not_disjoint1(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', set([' ', '\t', 'c']), LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_not_disjoint2(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', set([' ', '9', '\n']), LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_not_disjoint3(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', set(['+', '\t', '\n']), LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_not_disjoint4(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, set(['a', '1', 'c']), DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_not_disjoint5(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, set(['0', '1', '+']), PUNCTUATION, parse_int, parse_decimal)
    def test_init_not_disjoint6(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, set(['a', '+', '+']), parse_int, parse_decimal)
    def test_init_decimal_point_in_whitespace_chars(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', set([' ', '\t', '.']), LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_decimal_point_in_letters(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, set(['a', 'b', '.']), DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_decimal_point_in_digits(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, set(['0', '.', '2']), PUNCTUATION, parse_int, parse_decimal)
    def test_init_decimal_point_in_punctuation(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, set(['.', '+', '-']), parse_int, parse_decimal)
    def test_init_decimal_point_wrong_len(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '...', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    ...
    def test_init_function_bracket_wrong_len(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(..', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_same_function_bracket_left_decimal_point(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '.', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_same_function_bracket_right_decimal_point(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', '.', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_same_function_bracket_left_implicit_operation(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(BinaryOperation(1, None, '(', ['/', '//', '%'], None), FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_same_function_bracket_right_implicit_operation(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(BinaryOperation(1, None, ')', ['/', '//', '%'], None), FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_same_function_bracket_left_function_application_operator(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, BinaryOperation(1, None, '(', [], None), '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_same_function_bracket_right_function_application_operator(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, BinaryOperation(1, None, ')', [], None), '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_same_function_bracket_left_function_bracket_right(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', '(', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    ...
    def test_register_operation_same_token7(self):
        ...
        with self.assertRaises(ValueError):
            fd.register_operation(BinaryOperation(1, '-', '(', [], None))
    def test_register_operation_int_token(self):
        fd = FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
        with self.assertRaises(ValueError):
            fd.register_operation(BinaryOperation(1, '-', '123', [], None))
    def test_register_operation_decimal_token(self):
        fd = FunctionalityDatabase(IMPLICIT_OPERATION, FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
        with self.assertRaises(ValueError):
            fd.register_operation(BinaryOperation(1, '-', '1.23', [], None))
    ...
    def test_register_bracket_same_token14(self):
        fd = FunctionalityDatabase(IMPLICIT_OPERATION, BinaryOperation(1, None, '[', [], None), '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
        with self.assertRaises(ValueError):
            fd.register_bracket('[', ']')
    ...
    def test_register_constant_same_token7(self):
        fd = FunctionalityDatabase(BinaryOperation(1, None, 'x', ['/', '//', '%'], None), FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
        with self.assertRaises(ValueError):
            fd.register_constant('x', Rational(5, 1))
    def test_register_constant_same_token8(self):
        fd = FunctionalityDatabase(IMPLICIT_OPERATION, BinaryOperation(1, None, 'x', [], None), '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
        with self.assertRaises(ValueError):
            fd.register_constant('x', Rational(5, 1))
    ...
    def test_register_function_same_token7(self):
        fd = FunctionalityDatabase(BinaryOperation(1, None, 'f', ['/', '//', '%'], None), FUNCTION_APPLICATION_OPERATION, '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
        with self.assertRaises(ValueError):
            fd.register_function(Function('f', None))
    def test_register_function_same_token8(self):
        fd = FunctionalityDatabase(IMPLICIT_OPERATION, BinaryOperation(1, None, 'f', [], None), '(', ')', '.', WHITESPACE_CHARS, LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
        with self.assertRaises(ValueError):
            fd.register_function(Function('f', None))
    ...
    def test_is_int_false1(self):
        fd = create_fd()
        self.assertFalse(fd.is_int('.123'))
    def test_is_int_false2(self):
        fd = create_fd()
        self.assertFalse(fd.is_int('12.3'))
    def test_is_int_false3(self):
        fd = create_fd()
        self.assertFalse(fd.is_int('12a3'))
    ...
    def test_is_float_false2(self):
        fd = create_fd()
        self.assertFalse(fd.is_decimal('12a3'))
    def test_is_float_false3(self):
        fd = create_fd()
        self.assertFalse(fd.is_decimal('1.2.3'))
