...
class FunctionalityDatabaseTest(unittest.TestCase):
    def test_init(self):
        fd = FunctionalityDatabase(' ', '()', '(', '.', LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    ...
    def test_init_wrong_type5(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(' ', '()', '(', '.', 1, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_type6(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(' ', '()', '(', '.', LETTERS, 1, PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_type7(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(' ', '()', '(', '.', LETTERS, DIGITS, 1, parse_int, parse_decimal)
    def test_init_wrong_type8(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(' ', '()', '(', '.', set(['a', 'b', 3]), DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_type9(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(' ', '()', '(', '.', LETTERS, set(['0', 1, '2']), PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_type10(self):
        with self.assertRaises(TypeError):
            FunctionalityDatabase(' ', '()', '(', '.', LETTERS, DIGITS, set([',', '+', 2]), parse_int, parse_decimal)
    def test_init_wrong_len1(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(' ', '()', '(', '.', set(['a', 'b', 'cd']), DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_len2(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(' ', '()', '(', '.', LETTERS, set(['0', '12', '2']), PUNCTUATION, parse_int, parse_decimal)
    def test_init_wrong_len3(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(' ', '()', '(', '.', LETTERS, DIGITS, set([',', '+', '+-']), parse_int, parse_decimal)
    def test_init_not_disjoint1(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(' ', '()', '(', '.', set(['a', '1', 'c']), DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_not_disjoint2(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(' ', '()', '(', '.', LETTERS, set(['0', '1', '+']), PUNCTUATION, parse_int, parse_decimal)
    def test_init_not_disjoint3(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(' ', '()', '(', '.', LETTERS, DIGITS, set(['a', '+', '+']), parse_int, parse_decimal)
    def test_init_decimal_point_in_letters(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(' ', '()', '(', '.', set(['a', 'b', '.']), DIGITS, PUNCTUATION, parse_int, parse_decimal)
    def test_init_decimal_point_in_digits(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(' ', '()', '(', '.', LETTERS, set(['0', '.', '2']), PUNCTUATION, parse_int, parse_decimal)
    def test_init_decimal_point_in_punctuation(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(' ', '()', '(', '.', LETTERS, DIGITS, set(['.', '+', '-']), parse_int, parse_decimal)
    def test_init_decimal_point_wrong_len(self):
        with self.assertRaises(ValueError):
            FunctionalityDatabase(' ', '()', '(', '...', LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
    ...
    def test_register_constant_same_token7(self):
        fd = FunctionalityDatabase('x', '()', '(', '.', LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
        with self.assertRaises(ValueError):
            fd.register_constant('x', Rational(5, 1))
    ...
    def test_register_function_same_token7(self):
        fd = FunctionalityDatabase('f', '()', '(', '.', LETTERS, DIGITS, PUNCTUATION, parse_int, parse_decimal)
        with self.assertRaises(ValueError):
            fd.register_function(Function('f', None))
