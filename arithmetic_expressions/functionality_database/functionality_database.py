    ...
    def __init__(self, implicit_operation : str, function_application_operator : str, function_bracket : str, decimal_point : str, letters : set[str], digits : set[str], punctuation : set[str]):
        ...
        for letter in letters:
            ...
            if letter in digits or letter in punctuation:
                raise ValueError("letters, digits and punctuation must be disjoint")
        ...
        for c in punctuation:
            ...
            if len(c) != 1:
                raise ValueError("elements of punctuation must be of lengrh 1")
        
        if len(decimal_point) != 1:
            raise ValueError("decimal_point must be of length 1")
        if decimal_point in letters or decimal_point in digits or decimal_point in punctuation:
        ...
        if function_bracket in letters or function_bracket in digits or function_bracket in punctuation:
